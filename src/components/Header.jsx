    ...
    <section>
      <header className="container mx-auto px-5 flex justify-between py-4 items-center">
        ...
        >
          ...
          <button className="mt-5 lg:mt-0 border-2 border-orange-500 px-6 py-2 rounded-full text-orange-500 font-semibold hover:bg-blue-500 hover:text-white transition-all duration-300">
            Sign in
          </button>
        </div>
      </header>
